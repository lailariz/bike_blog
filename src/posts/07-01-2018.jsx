...
import barcelona from '../img/barcelona_sunset.jpg';
  ...
  render() {
    return (
      <div>
    	...
    	<p>{"We arrived in Barcelona with a sense of relief that (most) of the planning was done and the adventures were beginning. More importantly, I am feeling overwhelmed with kindness and generosity from the people who helped us get here and those we’ve met since arriving. Traveling here by myself was easy and my stay in Barcelona has been incredible. Special shout out to Emily for helping me pack and organize, to Grandma for cooking and showing me unconditional support and excitement, and Sonia for driving me to the Oakland airport on Tuesday afternoon."}</p>
    	...
    	<p>{"Ze’ev had befriended his Barcelona Airbnb hosts,Ricardo and Katlyn, a lovely and engaging couple from Colombia. They invited us to Barceloneta Beach on Thursday morning for an 8am workout. Obviously we went. They also invited us to go to the bar with them to watch the Colombia v Senegal World Cup soccer game that afternoon. Ze’ev couldn’t make it cause he had class, but I was thrilled to go with them. The bar was overflowing with Colombians in yellow jerseys cheering for their country. When Colombia scored and won the game, the room erupted with support and chants. It was sweet. Once again, I felt so lucky to have met these inviting and generous people in Barcelona."}</p>
	<p>{"In a couple days we are heading to Dubrovnik, Croatia to start our bike journey across Eastern Europe. One reason I love bike touring is because we get to meet people we wouldn’t otherwise talk to. People ask questions about our bikes and route, and we ask locals about things to see, roads to take, and places to eat. In doing so, we get to learn about their culture and experience acts of kindness that often get overlooked if you’re in a car or walking. We’re so excited to start our adventure and meet new people, see new things, and learn how kind people can be."}</p>
        </div>
      </div>
    );
  }
