    ...
    return (
      <div>
        ...
        <div className="post-content pb-2">
          <p>{"Upon arrival at the Dubrovnik airport, we began the 2-hour long unpacking and assembling process in the airport arrival lobby. Whew. Once we had all our gear packed onto our bike panniers, we just hoped on our bikes and biked away from the airport. Both excited and nervous, we began our 1500mi journey to Germany."}</p>
          ...
          <div className="row text-center d-block">
    	    ...
    	    <p>{"Marko returned with pants on but no shirt to introduce himself and his dog Jackie. He was kind, jolly, and spoke English well but with a thick accent. He instructed us to leave our bikes behind the house and to follow the path up the hill 70 meters until we reach the opening, which was where we could set up our tent. He told us that a young couple had lived up there for two years and built several shacks to live in, but recently moved away to raise their baby. We were welcome to sleep inside the shacks as long as we wrote them a thank you note. We could also pitch a tent, which was ultimately what we decided to do."}</p>
          <div className="row text-center d-block">
